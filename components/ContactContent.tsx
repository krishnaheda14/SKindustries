...
export default function ContactContent() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/919834263091?text=${message}`, '_blank')
  }
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mt-12 sm:mt-14 md:mt-16">
          <div className="card overflow-hidden">
            <iframe
              src="https://maps.google.com/maps?q=1%2F8+Savedi+Naka%2C+Manmad+Road%2C+Ahmednagar%2C+Maharashtra+414003&z=17&output=embed"
              width="100%"
              height="400"
              ...
              allowFullScreen
              loading="lazy"
              title="SK Industries & AS Industries Location - Savedi Naka, Ahmednagar"
            ></iframe>
          </div>
          <div className="mt-4 text-center">
            <a
              href="https://maps.app.goo.gl/mBPaGKE8FPzxqzJP9?g_st=aw"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-red-600 text-white rounded-lg font-semibold hover:bg-red-700 transition-colors shadow-md"
            >
