          ...
          <div className="slide-in-left">
            ...
            <div className="space-y-3 sm:space-y-4 text-gray-700 text-sm sm:text-base md:text-lg leading-relaxed">
              <p className="fade-in-up stagger-1">
                Established in <span className="font-bold text-red-600">1981</span>, SK Industries has been at the forefront of rolling shutter manufacturing in India for over four decades.
              </p>
