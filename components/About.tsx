          ...
          <div className="slide-in-left">
            ...
            <div className="mt-6 sm:mt-7 md:mt-8 flex flex-col sm:flex-row gap-4 sm:gap-5 md:gap-6 fade-in-up stagger-4">
              <div className="text-center sm:text-left">
                <div className="text-3xl sm:text-4xl font-black text-red-600 mb-1 sm:mb-2">39+</div>
                <div className="text-sm sm:text-base text-gray-700">Years Experience</div>
              </div>
              <div className="text-center sm:text-left">
                <div className="text-3xl sm:text-4xl font-black text-red-600 mb-1 sm:mb-2">50+</div>
                <div className="text-sm sm:text-base text-gray-700">Patti Designs</div>
              </div>
              <div className="text-center sm:text-left">
                <div className="text-3xl sm:text-4xl font-black text-red-600 mb-1 sm:mb-2">10000+</div>
                <div className="text-sm sm:text-base text-gray-700">Satisfied Customers</div>
              </div>
            </div>
          </div>
