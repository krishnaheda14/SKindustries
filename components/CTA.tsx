  ...
  return (
    <section className="py-20 gradient-bg text-white relative overflow-hidden">
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-10 left-10 w-40 h-40 bg-white rounded-full blur-3xl float"></div>
        <div className="absolute bottom-10 right-10 w-60 h-60 bg-red-300 rounded-full blur-3xl float" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-100 mb-10 fade-in-up stagger-1">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center fade-in-up stagger-2">
            <a 
              href="/contact" 
              className="group relative px-12 py-5 bg-white text-red-600 font-bold text-lg rounded-xl transition-all duration-300 transform hover:scale-110 hover:shadow-2xl pulse-glow"
            >
              <span className="relative z-10">Contact Us</span>
              <div className="absolute inset-0 rounded-xl bg-red-100 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </a>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-8">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex flex-col text-gray-100">
                  <span>+91 98342 63091</span>
                  <span>+91 73858 52854</span>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-100">Ahmednagar, Maharashtra</span>
              </div>
            </div>
          </div>
        </div>
