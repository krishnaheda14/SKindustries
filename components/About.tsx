      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
          <div className="slide-in-left">
            <h2 className="section-title mb-4 sm:mb-5 md:mb-6 text-3xl sm:text-4xl md:text-5xl">About SK Industries</h2>
            ...
            <div className="mt-6 sm:mt-7 md:mt-8 flex flex-col sm:flex-row gap-4 sm:gap-5 md:gap-6 fade-in-up stagger-4">
              <div className="text-center sm:text-left">
                <div className="text-3xl sm:text-4xl font-black text-industrial-accent mb-1 sm:mb-2">40+</div>
                <div className="text-sm sm:text-base text-gray-600">Years Experience</div>
              </div>
              <div className="text-center sm:text-left">
                <div className="text-3xl sm:text-4xl font-black text-industrial-accent mb-1 sm:mb-2">15+</div>
                <div className="text-sm sm:text-base text-gray-600">Product Designs</div>
              </div>
              <div className="text-center sm:text-left">
                <div className="text-3xl sm:text-4xl font-black text-industrial-accent mb-1 sm:mb-2">1000+</div>
          ...
          <div className="slide-in-right mt-8 lg:mt-0">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-industrial-accent to-yellow-500 rounded-xl sm:rounded-2xl transform rotate-3 scale-95 opacity-20"></div>
              <div className="relative bg-gradient-to-br from-industrial-dark to-industrial-steel p-6 sm:p-8 md:p-12 rounded-xl sm:rounded-2xl shadow-2xl text-white shimmer">
